...
public class mdlTablaEncabezadoIdentificador extends AbstractTableModel {
    
    private Class tipoColumnas[];
    private String Columnas[] ={
        "<html><br><h3>COMPONENTE</h3><br><br></html>",
        };
    private Boolean editables[];

    public mdlTablaEncabezadoIdentificador(int numCol) {
        configColum(numCol);
    }
