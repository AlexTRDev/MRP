...
public class mdlTablaCuerpoIdentificador extends AbstractTableModel {
    ...
    public mdlTablaCuerpoIdentificador(int numCol, Item oItem) {
        this.oItem = oItem;
        configColum(numCol);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        if(columnIndex==0){
            ...
            Identificador = "<br><h3>"+oItem.getIdentificador()+"</h3>";
            
            return "<html>"+Identificador+"</html>";
        }else{
            return null;
        }
    }
